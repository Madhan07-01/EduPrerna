...
export default function TeacherAuthPage() {
  ...
  return (
    <div className="max-w-md mx-auto space-y-4">
      ...
      <input value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" type="email" className="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm" />
