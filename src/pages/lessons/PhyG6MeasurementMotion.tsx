...
const LESSON_ID_TEXT = 'phy-g6-measurement-motion'
...
const SECTIONS = [
  {
    title: 'Introduction',
    content:
      'Physics studies matter, energy, and their changes. Motion is fundamental. Measurement assigns numbers to physical quantities and enables us to describe motion precisely.',
  },
  {
    title: '1. Physical Quantities',
    content:
      'Quantities that can be measured are physical quantities. Examples: length, mass, time, temperature, speed. Types: (1) Fundamental — cannot be defined using other quantities (length, mass, time). (2) Derived — defined using fundamental quantities (speed = distance ÷ time).',
  },
  {
    title: '2. Measurement',
    content:
      'Comparing a physical quantity with a standard unit. Units: Length (meter, m), Mass (kilogram, kg), Time (second, s), Temperature (°C). Instruments: ruler, measuring tape, clock, thermometer, balance.',
  },
  {
    title: '3. Motion',
    content:
      'Change in position with time. Types: (1) Uniform — equal distance in equal time; (2) Non‑uniform — unequal distance in equal time.',
  },
  {
    title: '4. Distance and Displacement',
    content:
      'Distance: total path (scalar). Displacement: shortest straight line between start and end (vector). Example: 5 m east then 3 m west → Distance = 8 m, Displacement = 2 m east.',
  },
  {
    title: '5. Speed',
    content:
      'Speed = Distance ÷ Time. Units: m/s, km/h. Example: 120 km in 2 h → 60 km/h.',
  },
  {
    title: '6. Time',
    content:
      'Measures duration of events. Instruments: clock, stopwatch, timer. SI unit: second (s).',
  },
  {
    title: 'Summary',
    content:
      'Measurement uses standard units to quantify physical quantities. Motion can be uniform or non‑uniform. Distance vs displacement; Speed = Distance ÷ Time.',
  },
]

const MCQS: MCQ[] = [
  { id: 'q1', question: 'Which is a derived quantity?', options: [
      { key: 'a', text: 'Length' }, { key: 'b', text: 'Mass' }, { key: 'c', text: 'Speed' }, { key: 'd', text: 'Time' },
    ], answer: 'c', explanation: 'Speed is derived from distance and time.' },
  { id: 'q2', question: 'Uniform motion means:', options: [
      { key: 'a', text: 'Unequal distance in equal time' }, { key: 'b', text: 'Equal distance in equal time' }, { key: 'c', text: 'Random movement' }, { key: 'd', text: 'Motion in circles' },
    ], answer: 'b', explanation: 'Uniform motion covers equal distances in equal time intervals.' },
  { id: 'q3', question: 'Displacement is:', options: [
      { key: 'a', text: 'Total path traveled' }, { key: 'b', text: 'Shortest path between start and end' }, { key: 'c', text: 'Distance × speed' }, { key: 'd', text: 'Time taken' },
    ], answer: 'b', explanation: 'Displacement is a vector from start to end point.' },
  { id: 'q4', question: 'SI unit of mass is:', options: [
      { key: 'a', text: 'Meter' }, { key: 'b', text: 'Kilogram' }, { key: 'c', text: 'Second' }, { key: 'd', text: 'Celsius' },
    ], answer: 'b', explanation: 'The SI unit of mass is kilogram (kg).' },
  { id: 'q5', question: 'Speed formula is:', options: [
      { key: 'a', text: 'Distance × Time' }, { key: 'b', text: 'Distance ÷ Time' }, { key: 'c', text: 'Time ÷ Distance' }, { key: 'd', text: 'Mass ÷ Time' },
    ], answer: 'b', explanation: 'Speed = Distance / Time.' },
]

export default function PhyG6MeasurementMotion() {
  ...
  const downloadMaterials = async () => {
    const lines: string[] = []
    lines.push('Lesson: Measurement and Motion')
    ...
    a.href = url
    a.download = 'Grade6_Physics_MeasurementAndMotion.txt'
    a.click()
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold">Lesson: Measurement and Motion</h1>
