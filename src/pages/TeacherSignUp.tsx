  ...
  return (
    <div className="mx-auto max-w-md p-6">
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        <div>
          ...
          <input 
            ...
            className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm dark:border-gray-600 dark:bg-gray-800 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" 
            value={name} 
        ...
        <button 
          disabled={loading} 
          className="w-full rounded-md bg-gradient-to-r from-indigo-600 to-emerald-600 px-3 py-2 text-white font-medium shadow-md hover:from-indigo-700 hover:to-emerald-700 disabled:opacity-60 transition-all duration-200"
        >
      ...
      <div className="mt-4 text-center">
        <Link to="/teacher-login" className="text-sm text-indigo-600 hover:underline dark:text-indigo-400">
