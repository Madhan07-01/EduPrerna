// Curriculum data for cascading dropdowns
export const curriculumData = {
  ...
  "ComputerScience": {
    ...
    "9": [
      ...
      "Cyber Safety",
      "Office Tools",
      "Scratch or Python Programming Basics",
      "Lab Exercises and Practical Usage"
    ],
    "10": [
      "Introduction to Programming",
      "Office Automation tools",
      "Internet and Network Basics",
      "Programming Language Concepts with Practicals"
    ],
    "11": [
      "Computer Fundamentals (hardware, software)",
      "Programming Methodology (Python)",
      "Introduction to C++",
      "Programming in C++",
      "Data Structures",
      "Operating Systems",
  ...
  "Biology": {
    ...
    "9": [
      "The Fundamental Unit of Life - Cell Theory",
    ...
    "10": [
      ...
      "Control & Coordination in Animals and Plants",
      "Heredity & Evolution",
    ...
    "11": [
      ...
      "Cell Structure and Function",
      "Plant Physiology",
      "Human Physiology (Digestive, Circulatory, Respiratory, Nervous, Reproductive Systems)"
    ],
    "12": [
...
export type Subject = keyof typeof curriculumData
export type Grade = string
export type Lesson = string

// Helper functions
export const getSubjects = (): Subject[] => {
  return Object.keys(curriculumData) as Subject[]
}

export const getGrades = (subject: Subject): Grade[] => {
  return Object.keys(curriculumData[subject] || {})
}

export const getLessons = (subject: Subject, grade: Grade): Lesson[] => {
  const subjectData = curriculumData[subject]
  if (!subjectData) return []
  return (subjectData as Record<string, string[]>)[grade] || []
}