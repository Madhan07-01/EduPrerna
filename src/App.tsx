...
import MathG6NumberSystem from './pages/MathG6NumberSystem'
import SupabaseSignIn from './pages/SupabaseSignIn'
import MathG6OperationsWholeNumbers from './pages/MathG6OperationsWholeNumbers'
import MathG6Integers from './pages/MathG6Integers'
import CSG6CategoriesComputersLanguages from './pages/CSG6CategoriesComputersLanguages'
import CSG6FileManagement from './pages/CSG6FileManagement'
import CSG6WordProcessorTables from './pages/CSG6WordProcessorTables'
import PhyG6MeasurementMotion from './pages/PhyG6MeasurementMotion'
import PhyG6LightShadowsReflections from './pages/PhyG6LightShadowsReflections'
import PhyG6ElectricityCircuits from './pages/PhyG6ElectricityCircuits'
import ChemG6IntroChemistry from './pages/ChemG6IntroChemistry'
import ChemG6MatterProperties from './pages/ChemG6MatterProperties'
import ChemG6AtomsMolecules from './pages/ChemG6AtomsMolecules'
import MathG7Integers from './pages/MathG7Integers'
import MathG7FractionsDecimals from './pages/MathG7FractionsDecimals'
import MathG7DataHandling from './pages/MathG7DataHandling'
import CSG7ProgrammingLanguages from './pages/CSG7ProgrammingLanguages'
import CSG7WordEditing from './pages/CSG7WordEditing'
import CSG7PowerPoint from './pages/CSG7PowerPoint'
import PhyG7MotionTime from './pages/PhyG7MotionTime'
import PhyG7ElectricCurrentCircuits from './pages/PhyG7ElectricCurrentCircuits'
import PhyG7Heat from './pages/PhyG7Heat'
import BioG7LifeProcesses from './pages/BioG7LifeProcesses'
import BioG7NutritionAnimalsPlants from './pages/BioG7NutritionAnimalsPlants'
import BioG7RespirationCirculation from './pages/BioG7RespirationCirculation'
import BioG6LivingNonLiving from './pages/BioG6LivingNonLiving'
import BioG6PlantsAnimals from './pages/BioG6PlantsAnimals'
import BioG6OurBodyHealth from './pages/BioG6OurBodyHealth'
import MathG8RationalNumbers from './pages/MathG8RationalNumbers'
import MathG8LinearEquations from './pages/MathG8LinearEquations'
import MathG8UnderstandingQuadrilaterals from './pages/MathG8UnderstandingQuadrilaterals'
import CSG8IntroComputerLanguage from './pages/CSG8IntroComputerLanguage'
import CSG8IntroDatabase from './pages/CSG8IntroDatabase'
import CSG8MSAccessDBMS from './pages/CSG8MSAccessDBMS'
import PhyG8ForcePressure from './pages/PhyG8ForcePressure'
import PhyG8Friction from './pages/PhyG8Friction'
import PhyG8Sound from './pages/PhyG8Sound'
import BioG8CellStructureFunction from './pages/BioG8CellStructureFunction'
import BioG8Tissues from './pages/BioG8Tissues'
import BioG8MovementLocomotion from './pages/BioG8MovementLocomotion'
import MathG9NumberSystems from './pages/MathG9NumberSystems'
import MathG9Polynomials from './pages/MathG9Polynomials'
import MathG9CoordinateGeometry from './pages/MathG9CoordinateGeometry'
import CSG9BasicsIT from './pages/CSG9BasicsIT'
import CSG9CyberSafety from './pages/CSG9CyberSafety'
import CSG9OfficeTools from './pages/CSG9OfficeTools'
import BioG9CellTheory from './pages/BioG9CellTheory'
import BioG9PlantAnimalCells from './pages/BioG9PlantAnimalCells'
import BioG9DiversityOrganisms from './pages/BioG9DiversityOrganisms'
import PhyG9Motion from './pages/PhyG9Motion'
import PhyG9ForceLaws from './pages/PhyG9ForceLaws'
import PhyG9Gravitation from './pages/PhyG9Gravitation'
import MathG10RealNumbers from './pages/MathG10RealNumbers'
import MathG10Polynomials from './pages/MathG10Polynomials'
import MathG10PairLinearEquations from './pages/MathG10PairLinearEquations'
import CSG10IntroProgramming from './pages/CSG10IntroProgramming'
import CSG10OfficeAutomation from './pages/CSG10OfficeAutomation'
import CSG10InternetNetworkBasics from './pages/CSG10InternetNetworkBasics'
import PhyG10LightReflectionRefraction from './pages/PhyG10LightReflectionRefraction'
import PhyG10HumanEyeColourfulWorld from './pages/PhyG10HumanEyeColourfulWorld'
import PhyG10Electricity from './pages/PhyG10Electricity'
import BioG10LifeProcesses from './pages/BioG10LifeProcesses'
import BioG10ControlCoordination from './pages/BioG10ControlCoordination'
import BioG10HeredityEvolution from './pages/BioG10HeredityEvolution'
import MathG11Sets from './pages/MathG11Sets'
import MathG11RelationsFunctions from './pages/MathG11RelationsFunctions'
import MathG11TrigonometricFunctions from './pages/MathG11TrigonometricFunctions'
import PhyG11PhysicalWorldMeasurement from './pages/PhyG11PhysicalWorldMeasurement'
import PhyG11Kinematics from './pages/PhyG11Kinematics'
import PhyG11LawsOfMotion from './pages/PhyG11LawsOfMotion'
import CSG11ComputerFundamentals from './pages/CSG11ComputerFundamentals'
import CSG11ProgrammingMethodologyPython from './pages/CSG11ProgrammingMethodologyPython'
import CSG11IntroCPP from './pages/CSG11IntroCPP'
import ChemG11SomeBasicConcepts from './pages/ChemG11SomeBasicConcepts'
import ChemG11StructureOfAtom from './pages/ChemG11StructureOfAtom'
import ChemG11ClassificationPeriodicity from './pages/ChemG11ClassificationPeriodicity'
import BioG11DiversityLivingOrganisms from './pages/BioG11DiversityLivingOrganisms'
import BioG11StructuralOrganization from './pages/BioG11StructuralOrganization'
import BioG11CellStructureFunction from './pages/BioG11CellStructureFunction'
import MathG12RelationsFunctions from './pages/MathG12RelationsFunctions'
import MathG12InverseTrig from './pages/MathG12InverseTrig'
import MathG12Matrices from './pages/MathG12Matrices'
import CSG12AdvancedProgramming from './pages/CSG12AdvancedProgramming'
import CSG12DataStructuresAlgorithms from './pages/CSG12DataStructuresAlgorithms'
import CSG12DBMSSQL from './pages/CSG12DBMSSQL'
import PhyG12Electrostatics from './pages/PhyG12Electrostatics'
import PhyG12CurrentElectricity from './pages/PhyG12CurrentElectricity'
import PhyG12MagneticEffects from './pages/PhyG12MagneticEffects'
import ChemG12SolidState from './pages/ChemG12SolidState'
import ChemG12Solutions from './pages/ChemG12Solutions'
import ChemG12Electrochemistry from './pages/ChemG12Electrochemistry'
import BioG12Reproduction from './pages/BioG12Reproduction'
import BioG12GeneticsEvolution from './pages/BioG12GeneticsEvolution'
import BioG12BiologyHumanWelfare from './pages/BioG12BiologyHumanWelfare'
